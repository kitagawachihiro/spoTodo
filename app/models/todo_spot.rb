class TodoSpot
    ...
    def initialize(user, params = {}, todo)
        ...
        if @todo.id.present?
            #todospotをセット
            self.assign_attributes(content: @todo.content, user_id: @todo.user_id, public: @todo.public, name: @todo.spot.name, address: @todo.spot.address, latitude: @todo.spot.latitude, longitude: @todo.spot.longitude)
        else
            #@todoをセット
